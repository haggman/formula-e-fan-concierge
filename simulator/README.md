...
Cloud Run service that replays Berlin 2024 R10 race telemetry at race pace, publishing a unified 1 Hz stream to Pub/Sub. Each participant's GCP project gets its own simulator instance, feeding the agent they build in Challenge 2 of the Google Cloud + Formula E hackathon.
